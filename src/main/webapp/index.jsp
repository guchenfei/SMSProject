...
<body style="background-color: #1c77ac; background-image: src="
	${APP_PATH }/static/images/light.png";background-repeat:
	...
	<div class="loginbody">
		...
		<div class="loginbox">
			<ul>
				...
				<li>
					<input name="" type="text" class="loginpwd" value="密码"
						onclick="JavaScript:this.value=''" />
				</li>
				<li>
					<input name="" type="button" class="loginbtn" value="登录"
						onclick="javascript:window.location='SMSProject/src/main/webapp/WEB-INF/views/main.jsp'" /><label><input
